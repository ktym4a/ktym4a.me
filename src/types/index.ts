...
export const COLORS: {
    ...
    [COLOR.BLUE]: {
        ...
        backgroundGradient: 'to-ctp-blue/30 dark:to-ctp-blue/20',
    ...
    [COLOR.GREEN]: {
        ...
        backgroundGradient: 'to-ctp-green/30 dark:to-ctp-green/20',
    ...
    [COLOR.PEACH]: {
        ...
        backgroundGradient: 'to-ctp-peach/30 dark:to-ctp-peach/20',
    ...
    [COLOR.PINK]: {
        ...
        backgroundGradient: 'to-ctp-pink/30 dark:to-ctp-pink/20',
